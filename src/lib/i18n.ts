export const translations = {
  ru: {
    ...
    auth: {
      ...
      nicknamePlaceholder: 'Только латиница, цифры, _ и -',
    },
    ...
    game: {
      ...
      correct: 'Засчитано!', wrong: 'Не засчитано', waiting: 'Ожидание проверки...',
  ...
  de: {
    ...
    auth: {
      ...
      loginBtn: 'Einloggen', registerBtn: 'Konto erstellen',
      nicknamePlaceholder: 'Nur Buchstaben, Zahlen, _ und -',
    },
  ...
  en: {
    ...
    auth: {
      ...
      loginBtn: 'Enter the game', registerBtn: 'Create account',
      nicknamePlaceholder: 'Letters, numbers, _ and - only',
    },
