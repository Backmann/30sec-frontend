...
type Tab = 'dashboard' | 'tournaments' | 'questions' | 'users' | 'feedback' | 'logs';
const RQ = 23;
...
export default function AdminPage() {
  ...
  const tabs: {id:Tab;icon:string;label:string}[] = [{id:'dashboard',icon:'D',label:'Дашборд'},{id:'tournaments',icon:'T',label:'Турниры'},{id:'questions',icon:'Q',label:'Вопросы'},{id:'users',icon:'U',label:'Игроки'},{id:'feedback',icon:'F',label:'Обратная связь'},{id:'logs',icon:'L',label:'Журнал'}];
